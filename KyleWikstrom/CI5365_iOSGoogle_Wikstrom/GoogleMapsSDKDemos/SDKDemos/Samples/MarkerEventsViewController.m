...
- (void)viewDidLoad {
  [super viewDidLoad];
  GMSCameraPosition *camera = [GMSCameraPosition cameraWithLatitude:47.433140
                                                          longitude:-96.856111
                                                               zoom:9];
  mapView_ = [GMSMapView mapWithFrame:CGRectZero camera:camera];

  GMSMarker *sydneyMarker = [[GMSMarker alloc] init];
  sydneyMarker.position = CLLocationCoordinate2DMake(47.909955, -97.038924);
  sydneyMarker.map = mapView_;

  melbourneMarker_ = [[GMSMarker alloc] init];
  melbourneMarker_.position = CLLocationCoordinate2DMake(46.846424, -96.785479);
